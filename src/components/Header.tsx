...
const Header = () => {
  ...
  const stories = [
    { id: 1, username: "Alex", avatarUrl: "/lovable-uploads/f8624281-c4d8-4e78-8b29-c0d8ef3ba36a.png", position: "object-[center_40%] scale-125" },
    ...
    { id: 3, username: "Sarah", avatarUrl: "/lovable-uploads/35a1a878-d132-4beb-97aa-800874b72f57.png", position: "object-[center_45%] scale-110" },
