...
const Header = () => {
  ...
  const stories = [
    ...
    { id: 2, username: "Qaiss", avatarUrl: "/lovable-uploads/93be06b4-bf6e-44c3-b1de-5902e9267580.png", position: "object-[center_60%] scale-125" },
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-black/90 backdrop-blur-sm border-b border-gray-800">
      <div className="px-4 py-2">
        ...
        <div className="flex space-x-6 overflow-x-auto pb-4 pr-20 scrollbar-hide max-w-[90%]">
          {stories.map((story) => (
