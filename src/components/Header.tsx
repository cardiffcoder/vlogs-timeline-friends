...
const Header = () => {
  ...
  const stories = [
    ...
    { id: 3, username: "Sophie", avatarUrl: "/lovable-uploads/35a1a878-d132-4beb-97aa-800874b72f57.png", position: "object-[center_45%] scale-110" },
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 border-b border-gray-800 transition-transform duration-300 relative ${
      ...
      <div 
        className="absolute inset-0 w-full h-full bg-cover bg-center opacity-45 blur-md"
        style={{
